                            ...
                            <div class="row p-20">
                                ...
                                <div class="col-lg-3 col-md-3">
                                    <x-forms.text :fieldLabel="__('payroll::modules.payroll.depositRefund')" fieldName="deposit_refund"
                                        fieldId="deposit_refund" :fieldPlaceholder="__('payroll::modules.payroll.depositRefund')" :fieldValue="0" :fieldValue="$allowance->deposit_refund" />
                                </div>
                            </div>
                                ...
                                <div class="col-lg-3 col-md-3">
                                 ...
                                 <div class="col-lg-3 col-md-3">
                                    <x-forms.text :fieldLabel="__('payroll::modules.payroll.incomeTax')" fieldName="income_tax" fieldId="income_tax"
                                        :fieldPlaceholder="__('payroll::modules.payroll.incomeTax')" :fieldValue="0" :fieldValue="$detection->income_tax"/>
                                </div>
                            </div>
