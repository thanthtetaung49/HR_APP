        ...
        <x-form id="save-payroll-form" method="PUT">
            <div class="add-client bg-white rounded">
                ...
                <div class="row p-20">
                    ...
                    <div class="col-lg-3 col-md-3">
                        <x-forms.text :fieldLabel="__('payroll::modules.payroll.deposit')" fieldName="deposit" fieldId="deposit" :fieldPlaceholder="__('payroll::modules.payroll.deposit')"
                            :fieldValue="$salarySlip->user->userDetection->deposit" />
                    </div>
                    <div class="col-lg-3 col-md-3">
                        <x-forms.text :fieldLabel="__('payroll::modules.payroll.Loan')" fieldName="loan" fieldId="loan" :fieldPlaceholder="__('payroll::modules.payroll.Loan')"
                            :fieldValue="$salarySlip->user->userDetection->loan" />
                    </div>
                    <div class="col-lg-3 col-md-3">
