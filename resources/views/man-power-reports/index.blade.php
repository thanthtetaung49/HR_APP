    ...
    <script>
        ...
        @if (canDataTableExport())
            $('#export-all').click(function() {
                let team = $('#team_id').val();
                let location = $('#location_id').val();
                let budgetYear = $('#budget_year').val();
                let position = $('#position').val();
                let quarter = $('#quarter').val();

                var url =
                    "{{ route('man-power-reports.export_all_attendance', [':location', ':team', ':position', ':budgetYear', ':quarter']) }}";
                url = url.replace(':location', location).replace(
                    ':team', team).replace(':position', position).replace(':budgetYear', budgetYear).replace(
                    ':quarter', quarter);
