    ...
    function sidebar_user_perms()
    {
        if (!cache()->has('sidebar_user_perms_' . user()->id)) {
            ...
            $sidebarPermissionsArray = [
                ...
                'edit_location',
                'delete_location',
                'view_management_ranks',
                'add_management_ranks',
                'edit_management_ranks',
                'delete_management_ranks',
                'view_sub_criteria',
                'add_sub_criteria',
                'edit_sub_criteria',
                'delete_sub_criteria',
                ...
                'view_man_power_reports',
                'add_man_power_reports',
                'edit_man_power_reports',
                'delete_man_power_reports',
